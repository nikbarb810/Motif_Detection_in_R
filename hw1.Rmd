...
print(glycoly_foreground["TTTGGCGG"])

#build background
background = processSequences(sampled_background, motifLength)

print(background["TTTGGCGG"])
...
#save variables
save(glycoly_p_smaller, file=paste("output//glycoly_p_smaller_",p_value,".RData"))
save(glyconeo_p_smaller, file=paste("output//glyconeo_p_smaller_",p_value,".RData"))

...
length(glycoly_upstream_seqs)

#for each gene of the list

#find all scores of its seqs
#keep best core in a list

#repeat for glyconeogenesis

test = lapply(glycoly_upstream_seqs[[1]] ,scoreSeqs, pwm=inp_pwm)
test

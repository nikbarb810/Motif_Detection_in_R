...
glycoly_back_scores = lapply(background_seqs[1:100000],scoreSeqs, pwm=glycoly_pwm$pwm)
glyconeo_back_scores = lapply(background_seqs[1:100000],scoreSeqs, pwm=glyconeo_pwm$pwm)
...
par(mfrow = c(1, 2), main="Background seqs scored using pwms")
...
glycoly_thresh = quantile(x=glycoly_back_sc_vec, probs=0.95)
glyconeo_thresh = quantile(x=glyconeo_back_sc_vec, probs=0.95)
